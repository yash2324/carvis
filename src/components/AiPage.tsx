...
function AiPage() {
  return (
    <div className='relative min-h-screen w-3/4 p-4 pb-16'>
      ...
      <div className="bg-[#D3D3D3]  mt-4 flex justify-end py-1 border-b-4 ml-20 rounded-sm">
